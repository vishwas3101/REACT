...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex fixed top-0 w-full items-start justify-between z-4'>
        <div className='lg:p-5 p-2 bg-black'>
        ...
        className='lg:h-14 h-11  lg:w-[12vw] w-34 relative bg-black'>
          <div ref={NavGreenraf}className='bg-[#e8ff70] absolute transition-all top-0 h-0 w-full'> 
          </div>
          <div className="relative  flex  justify-center flex-col-reverse gap-2">
